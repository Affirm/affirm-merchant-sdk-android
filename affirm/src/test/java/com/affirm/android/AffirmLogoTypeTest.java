...
public class AffirmLogoTypeTest {
    ...
    public void getDrawableResTest() {
        Truth.assertThat(AffirmLogoType.AFFIRM_DISPLAY_TYPE_LOGO.getDrawableRes(AffirmColor.AFFIRM_COLOR_TYPE_BLUE)).isEqualTo(R.drawable.affirm_blue_black_logo_transparent_bg);
        ...
        Truth.assertThat(AffirmLogoType.AFFIRM_DISPLAY_TYPE_TEXT.getDrawableRes(AffirmColor.AFFIRM_COLOR_TYPE_BLUE)).isEqualTo(R.drawable.affirm_blue_black_logo_transparent_bg);
        ...
        Truth.assertThat(AffirmLogoType.AFFIRM_DISPLAY_TYPE_SYMBOL.getDrawableRes(AffirmColor.AFFIRM_COLOR_TYPE_BLUE)).isEqualTo(R.drawable.affirm_blue_black_hollow_circle_transparent_bg);
        ...
        Truth.assertThat(AffirmLogoType.AFFIRM_DISPLAY_TYPE_SYMBOL_HOLLOW.getDrawableRes(AffirmColor.AFFIRM_COLOR_TYPE_BLUE)).isEqualTo(R.drawable.affirm_blue_black_hollow_circle_transparent_bg);
