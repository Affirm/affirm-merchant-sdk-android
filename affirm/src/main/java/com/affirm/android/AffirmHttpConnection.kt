...
internal class AffirmHttpConnection internal constructor(private val conn: HttpsURLConnection) : Closeable {

    val response: AffirmHttpResponse
        @Throws(IOException::class)
        get() {
            val responseCode = conn.responseCode
            return AffirmHttpResponse(
                code = responseCode,
                body = responseBody,
